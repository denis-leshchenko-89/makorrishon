...
class JNews_AMP
{
    ...
    protected function setup_hook()
    {
        ...
        add_action( 'jnews_amp_after_content2',          array( $this, 'outbrain_item' ) );
    ...
    public function related_item()
    {
...

        {
            ...
            if ( !empty( $contents ) )
            {
                ...
                {
                    //Nina - add writer name instead of auther
                    $writer = wp_get_object_terms($content->ID, 'writer');
                    if ($writer){
                        $writerfield = $writer[0];
                        $writer_name = $writerfield->name;
                    }
                        ...
                        "<div class='amp-related-content'>
                            ...
                            <div class='amp-related-text'>
                                ...
                                <div class='amp-related-meta'>
                                    ...
                                    <span class='amp-related-author'>{$writer_name}</span>
...
//    layout="responsive"
//    frameborder="0" src="https://amp.spot.im/production.html?spot_im_highlight_immediate=true&redirect=true&spotId=sp_KuOZ3qn7&postId='.$postid.'"
