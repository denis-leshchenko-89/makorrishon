...
if ( ! function_exists( 'jnews_auto_load_assets' ) ) {
    function jnews_auto_load_assets() { //Nina added opinion
        if ( ! is_customize_preview() && (is_singular( 'post' ) || is_singular( 'opinion' ))) {
...
//Nina - remove filter - for overide post template
