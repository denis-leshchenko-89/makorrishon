...
Class Image
{
    ...
    public function image_hook()
    {
        ...
        add_action('intermediate_image_sizes_advanced', array($this, 'unset_image_size'));
    ...
    public function unset_image_size($sizes)
    {
        unset( $sizes['medium']);
    ...
    public function setup_image_size()
    {
        ...
        (
            ...
            //added by nadav & oshri
            $this->prefix . 'avatar-90'         => array('width' => 90,  'height' => 90,  'crop' => true , 'dimension' => 1000),
            $this->prefix . 'category-1140x420' => array('width' => 1140, 'height' => 420,  'crop' => true , 'dimension' => 1000),

            $this->prefix . 'featured-1164' => array('width' => 1164, 'height' => 190,  'crop' => true , 'dimension' => 1000)
        );
    }
