...
//Nina Add after header option
$after_header = new \JNews\Customizer\AdsOptionGenerator(array(
    'location' => 'after_header',
    'title' => esc_html__('After Header', 'jnews'),
    'default_size' => '970x90',
    'visibility' => array(
        'desktop' => true,
        'tab' => true,
...
return array_merge(
    ...
    $after_header->ads_option_generator(),
