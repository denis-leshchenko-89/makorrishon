...
return array(
    ...
    // nadav edition
    array(
        'name'      => 'JNews_Element_Block13',
        'type'      => 'header',
        'widget'    => true
    ),
    array(
        'name'      => 'JNews_Element_Olive',
        'type'      => 'header',
        'widget'    => true
    ),
    array(
        'name'      => 'JNews_Element_ElectionsStrip',
        'type'      => 'block',
        'widget'    => true
    ),
    array(
        'name'      => 'JNews_Element_Link7',
        'type'      => 'block',
        'widget'    => true
    ),
    array(
        'name'      => 'JNews_Element_FacebookVideo',
        'type'      => 'block',
        'widget'    => true
    ),
    array(
        'name'      => 'JNews_Element_Link7MP3',
        'type'      => 'block',
        'widget'    => true
    ),
    // -------------
    ...
    array(
        'name'      => 'JNews_Widget_CategoryRecentNews',
        'type'      => 'widget',
        'widget'    => false
    ),
    array(
