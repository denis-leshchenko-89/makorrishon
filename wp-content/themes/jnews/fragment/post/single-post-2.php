        ...
        <?php if(have_posts()) : the_post(); ?>
            ...
            <div class="row">
                <div class="jeg_main_content col-md-<?php echo esc_attr($single->main_content_width()); ?>">
                    ...
                    <div class="jeg_inner_content 2">
                        <?php do_action('jnews_single_post_before_content'); ?>
                        <?php $categories = wp_get_post_categories($post->ID,'fields=ids');?>
                        <?php if(!in_array(23261, $categories)) {
                            $single->render_featured_post();
                        } ?>
                        ...
                        <div class="entry-content <?php echo esc_attr($single->share_float_additional_class()); ?>">
                            ...
                            <div class="content-inner <?php echo apply_filters('jnews_content_class', '', get_the_ID()) ?>">
                                <?php $categories = wp_get_post_categories($post->ID,'fields=ids');?>
                                <?php if(in_array(815, $categories) || in_array(23261, $categories)) { ?>
                                    <?php
                                    ...
                                    if ($collab) {
                                    ?>
                                    <div class="beshituf"><?php echo($beshituf. " " .$collabNoGeresh) ?></div><br>
                                <?php } else { ?>
                                <div class="beshituf"><?php echo($beshituf. " " .$authorNamesnoGeresh) ?></div><br>
                                <?php }}  ?>
                                ...
                                <?php  if ($collab) {
                                ?>
                                <div class="beshituf"><?php echo($beshituf. " " .$collabNoGeresh) ?></div>
                                <?php } else { ?>
                                <div class="beshituf"><?php echo($beshituf. " " .$authorNamesnoGeresh) ?></div>
                                <?php }}  ?>
